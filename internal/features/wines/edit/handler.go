...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		tmpl, err := template.New("edit.html").Funcs(ui.FuncMap).ParseFiles("internal/features/wines/edit/edit.html", "templates/header.html", "templates/footer.html", "templates/analytics.html")
		if err != nil {
